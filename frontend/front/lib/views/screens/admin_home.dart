...
import '../screens/admin_add_product.dart'; // <-- IMPORT DE LA PANTALLA DE CREACIÓN/EDICIÓN
...
class _AdminHomeScreenState extends State<AdminHomeScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      context
          ...
          .fetchCategories(); // Carga las categorías para el menú
    });
  }
  ...
  List<ProductModel> _getSortedAndPaginatedProducts(
  ...
  Widget build(BuildContext context) {
    ...
    final totalPages = (allProducts.length / _itemsPerPage).ceil().clamp(
      1,
      9999,
    );
    ...
    if (displayProducts.isNotEmpty) {
      final allVisibleSelected = displayProducts.every(
        (p) => _selectedProductIds.contains(p.id),
      );
      final someVisibleSelected = displayProducts.any(
        (p) => _selectedProductIds.contains(p.id),
      );
    ...
    return Scaffold(
      ...
      body: Stack(
        // <-- STACK PARA SUPERPONER EL MENÚ LATERAL
        children: [
          Column(
            children: [
              // HEADER IMPORTADO
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (_isWarehouseTab) ...[
                        AnimatedHoverButton(
                          onTap: () {
                            // NAVEGAR AL FORMULARIO VACÍO PARA CREAR
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) =>
                        ...
                        LayoutBuilder(
                          builder: (context, constraints) {
                            ...
                            return SingleChildScrollView(
                              ...
                              child: SizedBox(
                                width:
                                    tableWidth, // <-- ANCHO FINITO (Soluciona el crash)
                                child: Column(
                                  crossAxisAlignment:
                                ...
                                MouseRegion(
                                  ...
                                  child: GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      child: Icon(Icons.keyboard_arrow_left, color: _currentPage > 1 ? AppColors.blackColor : Colors.grey),
                                    ),
                                  ),
                                ),
                                ...
                                MouseRegion(
                                  ...
                                  child: GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      child: Icon(Icons.keyboard_arrow_right, color: _currentPage < totalPages ? AppColors.blackColor : Colors.grey),
                                    ),
                                  ),
                                ),
                              ],
                        ...
                        const Center(
                          child: Text('Panel de Pedidos en construcción'),
                        ),
                      ],
                    ],
                  ),
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Text(
          title,
          style: isActive
              ? AppTypography.colorWhite.titleLarge
